...
<body>
	<div id="container">
		...
		-->
			...
			<form id="login">
				<h2>
					<span class="fontawesome-lock"></span>Modificar Ruta
				</h2>
				<fieldset>
					...
					<p>
						<input type="text" name="nombreRuta"
							value="Camino de los siete lagos" />
					</p>
					...
					<p>
						<textarea name="descripcion">Esta ruta transitá el camino de los siete lagos. Etc</textarea>
					</p>

					<p>Privacidad:</p>
					<label for="privacidad_publica">Publica</label> <input
						id="privacidad_publica" type="radio" name="privacidad"
						value="publica" checked="checked" /> <label
						for="privacidad_privada">Privada</label> <input
						id="privacidad_privada" type="radio" name="privacidad"
						value="privada" />
            ...
            mymap.on('click', onMapClick);
					...
					<label for="formato_ida">Solo ida</label> <input id="formato_ida"
						type="radio" name="formato" value="ida" checked="checked" /> <label
					...
					<p>
						<input type="text" name="distancia" value="24km" />
					</p>
					...
					<p>
						<input type="text" name="tiempo" value="2hs" />
					</p>
					...
					<div>
						<select>
							...
							<option value="moderado" selected="selected">Moderado</option>
					...
					<div>
						<select>
							...
							<option value="cicloturismo" selected="selected">Cicloturismo</option>
